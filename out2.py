...
#
# Created: Tue Jun 12 12:27:01 2012
...
class Ui_TemplateConverter(object):
    def setupUi(self, TemplateConverter):
        TemplateConverter.setObjectName(_fromUtf8("TemplateConverter"))
        TemplateConverter.resize(483, 330)
        self.pushButton = QtGui.QPushButton(TemplateConverter)
        self.pushButton.setGeometry(QtCore.QRect(10, 20, 81, 21))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.line = QtGui.QFrame(TemplateConverter)
        self.line.setGeometry(QtCore.QRect(10, 50, 301, 16))
        self.line.setFrameShape(QtGui.QFrame.HLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName(_fromUtf8("line"))
        self.tabWidget = QtGui.QTabWidget(TemplateConverter)
        ...
        self.retranslateUi(TemplateConverter)
        ...
        QtCore.QMetaObject.connectSlotsByName(TemplateConverter)


    def retranslateUi(self, TemplateConverter):
        TemplateConverter.setWindowTitle(QtGui.QApplication.translate("TemplateConverter", "Template Converter", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton.setText(QtGui.QApplication.translate("TemplateConverter", "Convert", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.display), QtGui.QApplication.translate("TemplateConverter", "Display", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("TemplateConverter", "Root Directory:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("TemplateConverter", "Ex: .\\convert\\deep", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("TemplateConverter", "Endfile Extension:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_4.setText(QtGui.QApplication.translate("TemplateConverter", "Ex: _old.htm", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_2.setText(QtGui.QApplication.translate("TemplateConverter", "Save", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.settings), QtGui.QApplication.translate("TemplateConverter", "Settings", None, QtGui.QApplication.UnicodeUTF8))
...
if __name__ == "__main__":
    ...
    TemplateConverter = QtGui.QWidget()
    ui = Ui_TemplateConverter()
    ui.setupUi(TemplateConverter)
    TemplateConverter.show()
    sys.exit(app.exec_())
