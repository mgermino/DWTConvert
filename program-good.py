...
for x in filenames:
    ...
    for line in f:
        line=line.lower()
        outfile = codecs.open('extract.htm', 'a', 'utf-8')
    ...
    aList = []
    descriplist = [] 
    fileObj = codecs.open('extract.htm', 'r', 'utf-8')
    for line in fileObj:
    ...
    for line in f:
        if '<title>' in line:
            line=line.strip()
            outfile = codecs.open('meta2.htm', 'w', 'utf-8')
            outfile.writelines(line)
            outfile.writelines("\n")
        else:
            pass
    ...
    for line in f:
        if '<p class="PageBranding">' in line:
            line=line.strip()
            outfile = codecs.open('meta2.htm', 'a', 'utf-8')
            outfile.writelines(line)
        else:
            pass
    ...
    #mylist = []
    for line in codecs.open('meta.htm','r', 'utf-8').readlines():
        var = line.split()
        del var[0]
        del var[0]
        #del mylist[:]
    ...
    stripped = codecs.open("stripped.htm",'w', 'utf-8')
    ...
    meta2list = []
    fin = codecs.open("header.htm", 'r', 'utf-8')
    data2 = fin.read()
    fin.close()
    fout = codecs.open(endfile, "w", "utf-8")
    fout.write(data2)

    fin = codecs.open("header.htm", 'r', 'utf-8')
    data2 = fin.read()
    fin.close()
    fout = codecs.open('TESTER.htm', "w", "utf-8")
    fout.write(data2)
    ...
    fin = codecs.open("step1.html", 'r', 'utf-8')
    data2 = fin.read()
    fin.close()
    fout = codecs.open(endfile, "a", "utf-8")
    fout.write(data2)

    fin = open("step1.html", "r")
    data2 = fin.read()
    fin.close()
    fout = open('TESTER.htm', "w")
    fout.write(data2)
