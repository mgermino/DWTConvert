...
for x in filenames:
    ...
    lines = inp.readlines()
    for line in lines:
        if line.find('<!--webbot bot="Include" U-Include="../../_private/LeftNavMenu.htm" TAG="BODY" -->') != -1:
            pass
        else:
            goodf.write(line)
    ...
    #Copies everything below <td valign="top"></td> and places into file
    f = open('goodRanges.htm')
    f1 = open('final.htm', 'a')
    doIHaveToCopyTheLine=False
    for line in f.readlines():
      if '<td valign="top"></td>' in line:
    ...
    first, rest = text.split('<p align="center">####</p>',1)
    ...
    pilot2 = '<meta name="DC.date.created" scheme="ISO8601" '
    pilot3 = '<meta name="DC.date.modified" scheme="ISO8601" '
